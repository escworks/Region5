<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default2.aspx.cs" Inherits="Accountability_Default" EnableEventValidation="false"%>
 ...
 <tr>
    <td style="background-color:#ffffff; height:60px; border-bottom:solid 1px #667a95">
        <table width="100%" border="0">
            <tr>
                <td><img src='<%= ResolveUrl("~/lib/standard/img/r5_acct_logo.jpg")%>' alt="Region 5 Logo" height="50px"></td>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <tr>
                ...
                <td align="right">
                    ...
                    <asp:Label ID="DateOfServiceLabel"
                ...
                <td align="right">
                    <asp:Literal ID="litStrategies" runat="server"><font color="red">*</font></asp:Literal>
                    <asp:Label ID="StrategiesLabel"
                        text="Strategies:"
                        AssociatedControlID="ddlStrategies"
                        runat="server"></asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="ddlStrategies" runat="server" Width="200px" ClientID="ddlStrategies">
                    </asp:DropDownList>
                </td>
                <td align="right">
                ...
                <td>
                    <asp:DropDownList ID="ddlServiceLength" runat="server"  onfocus="ValidateForm();" >
                    </asp:DropDownList>
                </td>
            ...
            <tr>
                ...
                <table border="0" cellpadding="3" cellspacing="0">
                    ...
                    <td align="right"><%--Specific Site:--%></td>
                    <td>
            ...
            <tr>
                ...
                <td valign="top">
                <asp:DropDownList ID="ddlActivities" runat="server" Width="200px" ClientID="ddlActivities" OnSelectedIndexChanged="ddlActivities_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                </td>
                <td align="right">
                    <asp:Literal ID="litESC" runat="server"><font color="red">*</font></asp:Literal>
                    <asp:label ID="escGoalsLabel"
                        text="esc Goals:&nbsp;"
                        AssociatedControlID="ddlESC"
                        runat="server"></asp:label>
                </td>
                <td>
                    <asp:DropDownList ID="ddlESC" runat="server" Width="200px"></asp:DropDownList>
                </td>
                ...
                <td>
                    <asp:DropDownList ID="ddlTravelTime" runat="server" Width="80px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2">
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <asp:Panel ID="panelLeaveType" Visible="false" runat="server">
                            <td align="right">
                            <asp:Literal ID="litLeaveType" runat="server"><font color="red">*</font></asp:Literal>Leave Type:
                            </td>
                            <td>
                ...
                <td valign="top">
                <asp:DropDownList ID="ddlContactMethod" runat="server" Width="200px"></asp:DropDownList>
                </td>             
                </tr>
                <tr>
                    <td>
                    ...
                    <td colspan="5">
                         <asp:DropDownList ID="ddlCOVID19" runat="server" Width="200px"></asp:DropDownList>
                    </td>
                </tr>
                  <tr>
                                        ...
                                        <table border="0" width="410px" cellpadding="3" cellspacing="0">
					                        ...
					                        <tr>
						                        <td colspan="3">
                                                    ...
                                                    <asp:Label ID="IntegrityListBoxLabel"
                                                        text="<font color=#f5f5f5>Selected Values</font>"
               ...
               <div style="text-align:right">
                    <table width="30%">
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                <a style="cursor:pointer; text-decoration:underline; color:#48789b" onclick='window.open("<%= url %>report.aspx?cid=tx_r5&sid=<%= sid %>&id=1014","_blank","width=550 height=550 resizable=1")'>Current Time Sheet Report</a>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                <a style="cursor:pointer; text-decoration:underline; color:#48789b" onclick='window.open("<%= url %>report.aspx?cid=tx_r5&sid=<%= sid %>&id=1039","_blank","width=550 height=550 resizable=1")'>Current Time Sheet With Percent</a>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                <a style="cursor:pointer; text-decoration:underline; color:#48789b" onclick='window.open("<%= url %>report.aspx?cid=tx_r5&sid=<%= sid %>&id=1015","_blank","width=550 height=550 resizable=1")'>Summary Report</a>
                            </td>
                        </tr>
