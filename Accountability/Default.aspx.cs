...
public partial class Accountability_Default : BasePage
{
    ...
    {
        string script = "<script language='javascript' ID='Message'>window.open('default2.aspx','_blank','top=50, left=140, width=960, height=800, resizable=yes, scrollbars=1');</script>";
