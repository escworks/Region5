...
<head>
    ...
    <script type="text/javascript">
        function OnClientItemSelected(sender, eventArgs) {
            ...
            if (value == "2016-2017") {
                top.document.getElementById('iframe1').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/57f2bc34f6e399901f001234?folder=57d988dbdc3717b414000072&embed=true&r=false&l=false");
                top.document.getElementById('iframe2').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/57f2bcfff6e399901f001321?folder=57d988e4dc3717b414000074&embed=true&r=false&l=false");
                top.document.getElementById('iframe3').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/57f2b6abf6e399901f000d9b?folder=57d98901dc3717b414000078&embed=true&r=false&l=false");
                top.document.getElementById('iframe4').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/57f2bb69f6e399901f00117e?folder=57d98901dc3717b414000078&embed=true&l=false&r=false");
                top.document.getElementById('iframe5').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/56d9b0c8586e510814001057?folder=56d98ab3586e510814000396&embed=true&l=false");
            }
            else if (value == "2014-2015") {
                top.document.getElementById('iframe1').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/56d0a31d05befbd412000908?folder=56cc7ee16735627c8c000140&embed=true&l=false&r=false");
                top.document.getElementById('iframe2').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/56d0a5a305befbd41200096d?folder=56cc7ee16735627c8c000140&embed=true&l=false&r=false");
                top.document.getElementById('iframe3').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/56d0a8a205befbd412000a38?folder=56cc7fe96735627c8c000144&embed=true&l=false&r=false");
                top.document.getElementById('iframe4').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/56d0a8fe05befbd412000a93?folder=56cc7fe96735627c8c000144&embed=true&l=false&r=false");
                top.document.getElementById('iframe5').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/56d9b0c8586e510814001057?folder=56d98ab3586e510814000396&embed=true");
            }
            else if (value == "2015-2016") {
                top.document.getElementById('iframe1').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/56d0a6a705befbd4120009a2?folder=56cc7f806735627c8c000142&embed=true&l=false&r=false");
                top.document.getElementById('iframe2').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/56d0a80905befbd412000a03?folder=56cc7f806735627c8c000142&embed=true&l=false&r=false");
                top.document.getElementById('iframe3').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/56d0a8a205befbd412000a38?folder=56cc7fe96735627c8c000144&embed=true&l=false&r=false");
                top.document.getElementById('iframe4').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/56d0a8fe05befbd412000a93?folder=56cc7fe96735627c8c000144&embed=true&l=false&r=false");
                top.document.getElementById('iframe5').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/56d9b0c8586e510814001057?folder=56d98ab3586e510814000396&embed=true");
            }
...
<body link="#005695" vlink="#3399ff" alink="#3399ff">
    ...
    <div class="container">
        ...
        <header>
    <br /><br />
    <h1 align="center"><em>Welcome to the Region 5 Executive Dashboard</em></h1>
    <p align="center">&nbsp;</p>
  </header>
        <h5 align="center">
            Powered by:</h5>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0">
            <telerik:RadPageView runat="server" ID="RadPageView1">
                <section>
      <p></p>
                    <h2 align="center">About the Executive Dashboard...</h2>
            ...
            <telerik:RadPageView ID="RadPageView2" height="700px" runat="server">
                ...
                <h2><p></p>
                    ...
                    <iframe frameborder="1" scrolling="yes" width="99.7%" height="700px" radius-r="5px" id="iframe1" 
                        src="https://dashboard.escworks.net/app/main#/dashboards/57f2bc34f6e399901f001234?folder=57d988dbdc3717b414000072&embed=true&r=false&l=false">
                    </iframe>
             ...
             <telerik:RadPageView ID="RadPageView3" height="700px" runat="server">
                 ...
                 <h2><p></p>
                    ...
                    <iframe frameborder="1" scrolling="yes" width="99.7%" height="700px" radius-r="5px" id="iframe2" 
                        src="https://dashboard.escworks.net/app/main#/dashboards/57f2bcfff6e399901f001321?folder=57d988e4dc3717b414000074&embed=true&r=false&l=false">
                        </iframe>
             ...
             <telerik:RadPageView ID="RadPageView4" height="700px" runat="server">
                 ...
                 <h2><p></p>
                    ...
                    <iframe frameborder="1" scrolling="yes" width="99.7%" height="700px" radius-r="5px" id="iframe3" 
                        src="https://dashboard.escworks.net/app/main#/dashboards/57f2b6abf6e399901f000d9b?folder=57d98901dc3717b414000078&embed=true&r=false&l=false">
                        </iframe>
             ...
             <telerik:RadPageView ID="RadPageView5" height="700px" runat="server">
                 ...
                 <h2><p></p>
                    ...
                    <iframe frameborder="1" scrolling="yes" width="99.7%" height="700px" radius-r="5px" id="iframe4" 
                        src="https://dashboard.escworks.net/app/main#/dashboards/57f2bb69f6e399901f00117e?folder=57d98901dc3717b414000078&embed=true&l=false&r=false">
                        </iframe>
             ...
             <telerik:RadPageView ID="RadPageView6" height="600px" runat="server">
                 ...
                 <h2><p></p>
                    ...
                    <iframe frameborder="1" scrolling="yes" width="99.7%" height="700px" radius-r="5px" id="iframe5" 
                        src="https://dashboard.escworks.net/app/main#/dashboards/56d9b0c8586e510814001057?folder=56d98ab3586e510814000396&embed=true&l=false">
                        </iframe>
