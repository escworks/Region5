...
namespace tx_r16.Shoebox.Evaluation.Pages
{
	/// <summary>
    ...
    public partial class FormPage : System.Web.UI.Page
    {
        ...
        private DataSet ItemDS, HeaderDS;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                if (eForm.Title.ToLower() == ConfigurationManager.AppSettings["evaluation.professionalDevelopment.form"].ToLower())
                {
                    HeaderDS = eForm.LoadHeaders(mRegistrationId);
                    DataTable objHeader = HeaderDS.Tables["Headers"];
                    if (objHeader.Rows.Count > 0)
                    {
                        //litWorkshopTitle.Text = objHeader.Rows[0]["title"].ToString();
                        //litEventID.Text = objHeader.Rows[0]["eventId"].ToString();
                        //litSessionID.Text = objHeader.Rows[0]["sessionId"].ToString();
                        //litDate.Text = Convert.ToDateTime(objHeader.Rows[0]["date"].ToString()).ToShortDateString();
                        //litObjectives.Text = objHeader.Rows[0]["objectives"].ToString();
                        //litPresenters.Text = objHeader.Rows[0]["presenters"].ToString();

                        litProgramTitle.Text = objHeader.Rows[0]["programTitle"].ToString();
                        //litCourseTitle.Text = objHeader.Rows[0]["courseTitle"].ToString();
                        litDates.Text = objHeader.Rows[0]["dates"].ToString();
                        //litTime.Text = objHeader.Rows[0]["times"].ToString();
                        litProgramNumber.Text = objHeader.Rows[0]["programNumber"].ToString();
                        //litCompletionDate.Text = objHeader.Rows[0]["completionDate"].ToString();
                        //litLocation.Text = objHeader.Rows[0]["location"].ToString();
                        //litInstructor.Text = objHeader.Rows[0]["instructor"].ToString();
                        //litMaxClockHours.Text = objHeader.Rows[0]["maxClockHour"].ToString();
