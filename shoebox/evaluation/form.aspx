<%@ Page language="c#" Inherits="tx_r16.Shoebox.Evaluation.Pages.FormPage" EnableViewState="False" EnableViewStateMac="False" CodeFile="form.aspx.cs" %>
...
<head>
    ...
    <script language="javascript" type="text/javascript">
			function Page_OnInit()
			{
				...
				<asp:PlaceHolder ID="pComplete" Runat="Server" Visible="False">alert("Thank you for completing the form!");parent.window.opener.location.reload();parent.close();return false;</asp:PlaceHolder>
			}
...
<body onload="Page_OnInit();" style="margin: 0px; font-size: 8pt">
    ...
    <table cellspacing="0" cellpadding="0" width="555" height="100%" border="0">
        <asp:PlaceHolder ID="pHeader" runat="server" Visible="false">
			     <td colspan="2">
			        <table cellSpacing="0" cellPadding="0"  border="0">
			             <tr>
			                <td colspan="2">
			                    <table cellSpacing="0" cellPadding="2"  border="0" width="551">
			                        <tr>
			                            <td colspan="4"><b>Title:</b>&nbsp;<asp:Literal ID="litProgramTitle" runat="server" /></td>
			                        </tr>
			                       <%-- <tr>
			                            <td colspan="4"><b>Sub Title:</b>&nbsp;<asp:Literal ID="litCourseTitle" runat="server"/></td>
			                        </tr>--%>
			                        <tr>
			                        <%--    <td><b>Max Clock Hours:</b></td>
			                            <td valign="top"><asp:Literal ID="litMaxClockHours" runat="server"></asp:Literal></td>--%>

			                            <td><b>Workshop #:</b>
			                            <asp:Literal ID="litProgramNumber" runat="server"></asp:Literal></td>
                                      <td><b>WS Date(s):</b>
			                            <asp:Literal ID="litDates" runat="server"></asp:Literal></td>
			                        </tr>
			                      <%--   <tr>
			                            <td><b>Date(s):</b></td>
			                            <td><asp:Literal ID="litDates" runat="server"></asp:Literal></td>
			                            <td><b>Completion Date:</b></td>
			                            <td valign="top"><asp:Literal ID="litCompletionDate" runat="server"></asp:Literal></td>
			                        </tr>--%>
		<%--	                         <tr>
			                            <td><b>Time:</b></td>
			                            <td><asp:Literal ID="litTime" runat="server"></asp:Literal></td>
			                            <td valign="top"><b>Location:</b></td>
			                            <td><asp:Literal ID="litLocation" runat="server"></asp:Literal></td>

			                        </tr>--%>
			                        <tr><td colspan="4"><br /><br /></td></tr>
			                     <%--   <tr>
			                         <td colspan="4"><b>Instructor</b><br />
			                            Instructor:<asp:Literal ID="litInstructor" runat="server"></asp:Literal><br /><br />
			                         </td>   
			                       </tr>--%>
			                    </table>
			                </td>
